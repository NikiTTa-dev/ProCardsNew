...
namespace ProCardsNew.Infrastructure.Migrations
{
    ...
    [Migration("20230628181642_CardImageChange")]
    partial class CardImageChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProCardsNew.Domain.CardAggregate.ValueObjects.ImageData", b =>
                {
                    ...
                    b.ToTable("ImagesData", (string)null);
                });
            ...
            modelBuilder.Entity("ProCardsNew.Domain.UserAggregate.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PasswordRecoveryLastEmailSentDateTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ProCardsNew.Domain.CardAggregate.Card", b =>
                {
                    b.HasOne("ProCardsNew.Domain.CardAggregate.Entities.Image", "BackImage")
                        .WithMany("CardsWithBackSide")
                        .HasForeignKey("BackImageId");

                    b.HasOne("ProCardsNew.Domain.CardAggregate.Entities.Image", "FrontImage")
                        .WithMany("CardsWithFrontSide")
            ...
            modelBuilder.Entity("ProCardsNew.Domain.CardAggregate.ValueObjects.ImageData", b =>
                {
                    b.HasOne("ProCardsNew.Domain.CardAggregate.Entities.Image", "Image")
                        .WithOne("ImageData")
                        .HasForeignKey("ProCardsNew.Domain.CardAggregate.ValueObjects.ImageData", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProCardsNew.Domain.CardAggregate.Entities.Image", b =>
                {
                    b.Navigation("CardsWithBackSide");

                    b.Navigation("CardsWithFrontSide");
